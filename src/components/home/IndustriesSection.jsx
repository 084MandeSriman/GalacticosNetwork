...
//         .ultra-section {
//           position: relative;
//           background: radial-gradient(circle at top left, #0f172a 0%, #04082b 60%);
//           color: #fff;
//           padding: 120px 6%;
//           overflow: hidden;
...
//           <h2 className="title">
//             Flexible by <br />
//             <span className="gradient-text">High-Tech Design</span>
//           </h2>
//           <p className="desc">
//             We bridge visionary enterprises and elite talent using intelligent
//             engagement models focused on speed, transparency, and scalable innovation.
//           </p>
//         </div>
...
//             <p>On-demand experts augmenting your internal teams seamlessly.</p>
//           </div>

//           <div className={`card reveal ${isVisible ? "active" : ""}`} style={{ transitionDelay: "0.4s" }}>
//             <h3>Managed Services</h3>
//             <p>Outcome-driven delivery with complete ownership of engineering execution.</p>
//           </div>

//           <div className={`card reveal ${isVisible ? "active" : ""}`} style={{ transitionDelay: "0.6s" }}>
//             <h3>Dedicated Centers</h3>
//             <p>Your offshore innovation hub fully managed with cultural alignment.</p>
//           </div>
//         </div>
//       </div>
//     </section>
