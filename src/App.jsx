...
//         {/* QA */}
//         <Route path="/services/qa/automation" element={<AutomationTesting />} />
//         <Route path="/services/qa/continuous-testing" element={<ContinuousTesting />} />
//         <Route path="/services/qa/performance" element={<PerformanceTesting />} />
//         <Route path="/services/qa/selenium" element={<Selenium />} />
//         <Route path="/services/qa/playwright" element={<Playwright />} />
...
//         {/* Data */}
//         <Route path="/services/data/etl" element={<ETL />} />
//         <Route path="/services/data/data-lakes" element={<DataLakes />} />
//         <Route path="/services/data/warehousing" element={<Warehousing />} />
...
//         {/* Case Studies */}
//         <Route path="/case-study/digital-transformation" element={<DigitalTransformation />} />
//         <Route path="/case-study/life-sciences-innovation" element={<LifeSciencesInnovation />} />
//         <Route path="/case-study/financial-services-modernization" element={<FinancialServicesModernization />} />
//         <Route path="/case-study/hedge-fund-platforms" element={<HedgeFundPlatforms />} />
//         <Route path="/case-study/genai-enablement" element={<GenAIEnablement />} />
//         <Route path="/case-study/smarter-business-solutions" element={<SmarterBusinessSolutions />} />
//       </Routes>
